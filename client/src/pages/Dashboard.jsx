  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-[var(--bg-primary)] rounded-xl shadow-sm border border-[var(--border-color)] p-6">
        ...
        <p className="text-xs text-[var(--text-secondary)] mt-1">
          {stats?.links.favorites} favorites
        </p>
      </div>
    </div>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-[var(--text-primary)] group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    AI-Powered Tutoring
                  </h4>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-[var(--text-primary)] group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-[var(--text-primary)] group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                    Career Guidance
                  </h4>
                  <p className="text-sm text-[var(--text-secondary)] mt-1">
